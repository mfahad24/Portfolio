...
function Portfolio() {
  return <div id="portfolio" className="portfoliocontainer">
      <div className="tile1">
          <div className="projectcontainer"><a href="https://mfahad24.github.io/Budget-Buddy/" target="_blank" rel="noopener noreferrer"><img src={BudgetBuddy} alt="Budget Buddy"></img></a></div>
          {/* <div className="descriptiontab descriptionone"><h3 className="projecttitle">Budget Buddy</h3><p></p></div> */}
          </div>
          <div className="tile2">
          <div className="projectcontainer"><a href="https://mfahad24.github.io/MovieFinder/" target="_blank" rel="noopener noreferrer"><img src={SwipeNChill2} alt="Swipe N Chills"></img></a></div>
