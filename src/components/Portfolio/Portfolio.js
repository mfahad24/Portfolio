...
const projects = [
  ...
  },
  {
    ...
    tooltip:
      "HTML, CSS, JavaScript, React, React Hooks, TypeScript, Fetch, Modular CSS, Vite, Google Sheets API (README and live view pending)",
  },
  {
    ...
    alt: "Weather App",
    tooltip:
      "React (Class Components), Fetch, Open Weather API & React Testing Library",
  },
  {
    ...
    alt: "Calendar App",
    tooltip:
      "React (Functional Components), React Hooks, TypeScript, React Testing Library & Material UI",
  },
  {
...

  {
    ...
    tooltip:
      "React (Functional Components), React Hooks, TypeScript, Axios, Modular CSS, Node, Express, MySQL, React Testing Library & Material UI",
  },
];
